...
public class ManageScreen extends JPanel {
    ...
    private void filterButtonPressed (boolean [] needFilter,String [] filterBy){
       ...
       filterBy[Constants.NAME_FILTER] = passengerNameField.getText().trim();
        needFilter[Constants.SEX_FILTER]=checkIfSexFill((String) sexOfPassengerComboBox.getSelectedItem());
       ...
       filterBy[Constants.PARCH_FILTER] = passengerParchField.getText().trim();
        ...
        needFilter[Constants.EMBARKED_FILTER]= checkIfEmbarkedFill((String)  passengerEmbarkedComboBox.getSelectedItem());
